...
SECRET_KEY = 'django-insecure-$b!@p!ja$&t&31&^81ramq+u&l!x)1nk+qr7y9yh+9v63c47!m'
...
MEDIA_URL = '/emprestimos/imagens/'
MEDIA_ROOT = os.path.join(BASE_DIR,'emprestimos','imagens')
